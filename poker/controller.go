...
import (
	...
	samplev1alpha1 "github.com/Huang-Wei/kubecon-demo/pkg/apis/samplecontroller/v1alpha1"
...
func (c *Controller) syncHandler(key string) error {
	...
	// If this number of the replicas on the Foo resource is specified, and
	// the number equals the number of replicas in the status, change the
	// number of replicas to something else
	if foo.Spec.Replicas != nil && *foo.Spec.Replicas == foo.Status.AvailableReplicas {
