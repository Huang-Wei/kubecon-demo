...
import (
	...
	samplecontrollee_v1alpha1 "github.com/Huang-Wei/kubecon-demo/pkg/apis/samplecontrollee/v1alpha1"
	...
	v1alpha1 "github.com/Huang-Wei/kubecon-demo/pkg/client/listers/samplecontrollee/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SamplecontrolleeV1alpha1().Bars(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SamplecontrolleeV1alpha1().Bars(namespace).Watch(options)
			},
		},
		&samplecontrollee_v1alpha1.Bar{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *barInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&samplecontrollee_v1alpha1.Bar{}, f.defaultInformer)
}
