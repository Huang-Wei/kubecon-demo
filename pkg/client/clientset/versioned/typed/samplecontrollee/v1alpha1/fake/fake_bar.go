...
type FakeBars struct {
	Fake *FakeSamplecontrolleeV1alpha1
	ns   string
}

var barsResource = schema.GroupVersionResource{Group: "samplecontrollee.k8s.io", Version: "v1alpha1", Resource: "bars"}

var barsKind = schema.GroupVersionKind{Group: "samplecontrollee.k8s.io", Version: "v1alpha1", Kind: "Bar"}
